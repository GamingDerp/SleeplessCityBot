...
[![v - 0.9.1](https://img.shields.io/badge/v-0.9.1-FF0000)](https://)
...
# 📋 Features
**55** commands across **6** different categories.
...
- 🧮 **Misc:** `Whois`, `Avatar`, `Snipe`, `Deathhelp`, `Pickle`, `Remind` and **3** more!
